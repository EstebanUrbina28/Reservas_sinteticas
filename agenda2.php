...
<div class="people-you-might-know">
  ...
  <div class="row add-people-section">
   ...
   <tbody>
       <?php 
            ...
            $sql2 = "select hora,nombre,telefono,fecha from clientes  where id_cli= 15";
  ...
  <div class="row add-people-section">
   ...
   <tbody>
      ...
      //abrir conexión   
      //prepara y ejecuta consulta en BD 
      $sql = "select hora,nombre,telefono,fecha from clientes  where id_cli= 20";
      //$sql2= "SELECT hora,nombre,telefono,fecha,precio FROM clientes 
        //    JOIN factura ON clientes.id_cli=factura.id_cli
  ...
  <div class="row add-people-section">
   ...
   <tbody>
       <?php 
            ...
            //abrir conexión   
            //prepara y ejecuta consulta en BD 
            $sql = "select hora,nombre,telefono,fecha from clientes  where id_cli= 17";
  ...
  <div class="row add-people-section">
   ...
   <tbody>
       <?php 
            ...
            //abrir conexión   
            //prepara y ejecuta consulta en BD 
            $sql = "select hora,nombre,telefono,fecha from clientes  where id_cli= 18";
  ...
  <div class="row add-people-section">
   ...
   <tbody>
       <?php 
            ...
            //abrir conexión   
            //prepara y ejecuta consulta en BD 
            $sql = "select hora,nombre,telefono,fecha from clientes  where id_cli= 19";
